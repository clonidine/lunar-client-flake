{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.7.15-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-7TeJogN1CiWXyOyaw9bJMdHEl4exLkQnMN6P8lkAhfY="; # LUNAR_HASH
      };
