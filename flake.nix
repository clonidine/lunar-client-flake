{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.6.12-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-G5H94lJqj31Lk6jHb5ycOYye9LiRKFzv6d9Bwcu3GqU="; # LUNAR_HASH
      };
