{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.6.7-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-KTh/z9yvQTOJqCWnGXo2vQcI6Z5HFNWrlR+t5r48gVc="; # LUNAR_HASH
      };
