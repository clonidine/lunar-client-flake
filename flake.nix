{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.6.8-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-4LvGM3mMCiFWuA/jl+V26t7q9/PdH1fkWQ2j9K8X4WI="; # LUNAR_HASH
      };
