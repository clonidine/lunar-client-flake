{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.5.22-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-l6rEoRD2wQ/ZgOzKLQkHMYqWU1O3GRw1aIF9oco1eXs="; # LUNAR_HASH
      };
