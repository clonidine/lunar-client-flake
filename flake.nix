{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.7.6-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-NnJ3I1sxGU+Y1teJYWajXmhrF8n3UksONrINKqrehSQ="; # LUNAR_HASH
      };
