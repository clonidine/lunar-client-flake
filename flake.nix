{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.6.10-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-uCM46AlQJm0UnJeW42ohqJG9gmyh589tnXM6Yngptxc="; # LUNAR_HASH
      };
