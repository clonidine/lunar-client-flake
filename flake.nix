{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.7.14-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-7qhEo6GrD4x9pUuIqLe9hw/+vftqy4r60nAUmlSqKUM="; # LUNAR_HASH
      };
