{
  ...
  outputs =
    ...
    let
      ...
      src = pkgs.fetchurl {
        # LUNAR_URL
        url = "https://launcherupdates.lunarclientcdn.com/Lunar%20Client-3.7.9-ow.AppImage"; # LUNAR_URL
        name = "lunar-client-${version}.AppImage";
        sha256 = "sha256-7FkckzUSpxHXJB1m8n8oA0y7gvFvg1vsoV7TUEA9dhY="; # LUNAR_HASH
      };
